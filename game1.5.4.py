...
locations = {
    'home': {
        ...
        'options': ['hack into system', 'check emails', 'go to the park', 'shake magic 8 ball', 'quit']
    },
    'park': {
    ...
    'infosec_conference': {
        ...
        'options': ['attend lecture', 'network with professionals', 'visit vendor booths', 'grab free swag', 'head back home', 'quit']
    },
    'bookstore': {
...
#-------
    ...
    def memory_match_game():
        ...
        print("Congratulations! You've matched all the ports with their services.")
...
#-------
    ...
    if choice == 'minigames':
        print('The current minigames are: 1- Tarot Card Reading in the casino, 2- Duck Duck Goose in the park, 3- Magic 8 ball at home, 4- Rock Paper Scissors (sunscreen game) at the pool, 5- Word Unscramble at the hotel buffet, 6- The Cell Phone number guessing game, 7- Blackjack at the casino. 8- Badge soldering at the hacker space')
        continue
 ...
 #------------------------------------------------------------------------------------------------------------
    ...
    # Sticker Swap
        ...
        if choice == 'trade stickers':
            print('You have saved up some stickers and made a few to share. You see the great sticker guy, who people don\'t appreciate enough.')
